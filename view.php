      ...
      <table id="bizcanvas" cellspacing="0" border="1">
        ...
        <tr>
          <td colspan="2" >
            ...
            <pre class="resources"><?php  echo $_POST['f6'];    ?></pre>
          </td>
          <td colspan="2">
            <h4>Channels <i class="fa fa-truck"></i></h4>
            <pre class="channels"><?php  echo $_POST['f3'];    ?></pre>
          </td>
        </tr>
        <tr >
          <td colspan="5">
            <h4>Cost Structure <i class="fa fa-tags"></i></h4>
            <pre class="cost"><?php  echo $_POST['f9'];    ?></pre>
          </td>
          <td colspan="5">
            <h4>Revenue Streams <i class="fa fa-usd"></i></h4>
            <pre class=" revenue"><?php  echo $_POST['f5'];    ?></pre>
          </td>
        </tr>
      </table>
      <!-- /Canvas -->
...
<div class="btn-subm" >
 ...
 <div class="fields">
   ...
   <input class="project"type ="name" placeholder="Project name" name="project"></br>
   <input  class="email"type ="email" placeholder="YOUR EMAIL" name="email">
 </div>


  <button  class="bs"type="submit"> Submit</button>       <input type="button" class="print-btn" value="print" onclick="window.print()">
